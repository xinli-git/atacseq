...
input_json=~/projects/atacseq/atac_durga/json/20180404-3-muscle-1-5_S16.json
input_json=$1
...
# local run
java -jar -Dconfig.file=${backend_conf} ${cromwell_jar} run ${cromwell_wdl} -i ${input_json}
